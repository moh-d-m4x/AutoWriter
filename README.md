...
[🖥️ تطوير على كود الكمبيوتر](#للتطوير-على-كود-الكمبيوتر) • [📱 تطوير على كود الأندرويد](#للتطوير-على-كود-الأندرويد) • [📖 دليل الاستخدام](#%EF%B8%8F-واجهة-التطبيق---شرح-تفصيلي)
...
| 🤖 **تحسين بالذكاء الاصطناعي** | تحسين النصوص باستخدام Gemini AI |
| 🎤 **تحويل الصوت لنص** | إدخال النص بالصوت على Android |
</div>
...
|----------------|-------|
| 🤖 **تحسين النص بالذكاء الاصطناعي** | زر ✨ بجانب حقل "الموضوع" يستخدم Gemini AI لتحسين وتنسيق النص تلقائياً. يمكن تخصيص مفتاح API والتعليمات من الإعدادات. |
| 🎤 **تحويل الصوت إلى نص (STT)** | زر 🎙️ بجانب حقل "الموضوع" على Android يتيح إدخال النص بالصوت. يتوقف تلقائياً بعد فترة صمت قصيرة. |
| 📏 **توسع تلقائي للحقل** | حقل الموضوع يتوسع تلقائياً عند الإدخال بالصوت. |
...
زر دائري يظهر في الزاوية العلوية يسار الشاشة. اضغط عليه لـ:
...
│   └── app/src/main/
│       ├── java/                         # كود Java
│       │   ├── com/autowriter/app/       # الكود الرئيسي للتطبيق
│       │   └── org/libreoffice/kit/      # LibreOfficeKit wrapper
│       └── jniLibs/                      # مكتبات LibreOfficeKit الأصلية
│           ├── README.md                 # تعليمات الحصول على المكتبات
│           └── arm64-v8a/                # مكتبات 64-بت
│               ├── liblo-native-code.so  # (~182 MB - Git LFS)
│               └── *.so                  # مكتبات NSS/SSL
├── 📂 ref/                              # الموارد المطلوبة
│   └── template.docx                     # قالب Word الأساسي
├── 📂 docs/                             # لقطات الشاشة للتوثيق
├── 📂 public/                           # ملفات ثابتة
├── 📄 .gitattributes                    # إعدادات Git LFS للملفات الكبيرة
